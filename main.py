...
class MANAGER(TEMPLATES):
    ...
    def buy_manager(self, set_item):
        ...
        buy_time_ms = self.listing_time_ms - (set_item.get(f"delay_time_ms_server{self.railway_server_number}", None) + int(self.incriment_time_ms*4.5))    
        try:              
